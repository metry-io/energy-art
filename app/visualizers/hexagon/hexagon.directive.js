            ...
            d3Service.d3().then(function(d3){
              ...
              scope.$watch(function() {
                ...
                scaleX = d3.scale.linear()
                  .domain([0, hDist * hRes])
                  .range([0, angular.element(window)[0].innerWidth + hexagonSize]);

                scaleY = d3.scale.linear()
                  .domain([0, vDist * vRes])
                  .range([0,angular.element(window)[0].innerHeight + vDist]);
              ...
              scope.render = function(hexagons){
                ...
                vis.attr("width", angular.element(window)[0].innerWidth + legendOffset)
                  .attr("height", angular.element(window)[0].innerHeight);
                ...
                vis.append("g")
                  .attr("transform", "translate(60,0)")
                  .append("svg")
                  .attr("width", angular.element(window)[0].innerWidth)
                  .attr("height", angular.element(window)[0].innerHeight)
                  .selectAll("polygon")
                  .data(hexagons)
